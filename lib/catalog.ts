...
export const products: Product[] = [
  {
    ...
    name: "外泌体相关修护精华",
    subtitle: "适合术后护理场景咨询后使用",
    price: 699,
    unit: "30ml / 瓶",
    category: "皮肤护理",
    tags: ["屏障护理", "敏感肌友好", "检测报告待上传"],
    storage: "建议阴凉避光保存，开封后按包装说明使用。",
    usage: "洁面后取适量涂抹于面部，初次使用建议先做局部测试。",
    summary:
      "以皮肤日常护理和术后辅助护理场景为主，页面预留批次、检测报告、成分说明和客服咨询入口。",
    details: [
      "支持展示成分说明、适用人群、使用步骤与注意事项。",
      "支持按批次绑定检测报告，便于用户购买前查看资料。",
      "不承诺治疗、替代药品或医疗器械效果。",
    ],
    compliance: ["产品备案信息", "第三方检测报告", "生产企业资质"],
  },
  {
    slug: "exo-freeze-dried-powder",
    name: "外泌体相关冻干粉套组",
    subtitle: "护理机构合作款，支持客服确认后下单",
    price: 1299,
    unit: "5 支 / 盒",
    category: "专业护理",
    tags: ["机构咨询", "冷链提示", "批次管理"],
    storage: "按产品标签要求保存；如需冷链运输，订单确认时提示用户。",
    usage: "建议由专业人员按产品说明进行操作。",
    summary:
      "面向更高客单价和更强咨询需求的商品，重点展示资料完整性、配送说明和售后边界。",
    details: [
